...
//  DdokDoc
//
//  Created by Rebecca Ha on 2022/08/06.
//
...
class NaverImageDataManager {
    ...
    func fetchImage(place_name: String, location: String, completion: @escaping (String) -> Void) {
        ...
        AF.request(Constant.NAVER_URL, method: .get, parameters: params, encoder: URLEncodedFormParameterEncoder.default, headers: Keys.naverHeaders)
            .validate()
